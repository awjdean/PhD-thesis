\chapter{
 ...
 \draftnote{purple}{Footnote}{Say what a \emph{finite directed walk} is.}
...
\draftnote{blue}{Consider}{Is this a proposition?}
\footnote{
...
\end{equation}
\draftnote{blue}{Consider}{Is this a proposition that we need to prove?}
