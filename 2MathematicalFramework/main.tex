...
\newthought{In this chapter}, we describe a mathematical framework of the structure of the transformations of a world from the perspective of an agent\footnote{In our context, an \emph{agent} is an entity that can interact with our world and learn its structure.}.
