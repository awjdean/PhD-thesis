...
\textbf{Notes:}
\begin{enumerate}
    \item (DONE) Motivate and define equivalence relation for transitions.
    \item (DONE) Multigraph as a category.
    \item (DONE) Equivalence relation for actions.
    \begin{enumerate}
        \item Local vs global equivalence relations. - here or in Beyond SBDRL section?
    \end{enumerate}
    \item (DONE) Conditions for group action.
    \item Example - use one of the examples given in Higgins.
...
\whendraft{
\textbf{INTRODUCE THE CYCLICAL EXAMPLE HERE - STATES.}

Have the walled example in the previous section.
}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{2MathematicalFramework/ReproducingSBDR/SBDRL-description}
