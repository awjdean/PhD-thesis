...
We have constructed our transformations this way because it means that each transformation in $D$ can be represented as a unique composition of minimum transformations \draftnote{blue}{awjdean}{Reword this sentence.}.
...
We denote the set of trivial transformations by $D_{\epsilon}$ \draftnote{blue}{awjdean}{Equation environment defining $D_{\epsilon}$.}.
...
For any $d, d' \in D$ with $d = \hat{d}_{n} \hat{\circ} \hat{d}_{n-1} \hat{\circ} ... \hat{\circ} \hat{d}_{1}$ and $d' = \hat{d'}_{n} \hat{\circ} \hat{d'}_{n-1} \hat{\circ} ... \hat{\circ} \hat{d'}_{1}$, $d' \circ d = d''$ where $d'' \in D$ is defined, $d'' = \hat{d'}_{n} \hat{\circ} \hat{d'}_{n-1} \hat{\circ} ... \hat{\circ} \hat{d'}_{1} \hat{\circ} \hat{d}_{n} \hat{\circ} \hat{d}_{n-1} \hat{\circ} ... \hat{\circ} \hat{d}_{1}$ \draftnote{blue}{awjdean}{Put definition of $\circ$ in equation env.}.
	...
	\begin{enumerate}
		\item \textbf{Figures:}
		      \begin{itemize}
                  ...
                  \begin{figure}[H]
            	\centering
            	\includegraphics[scale = 0.35]{2MathematicalFramework/InitialFramework/Images/W_to_O_to_Z_mapping.png}
...
\begin{proposition}\label{prp:circ_sim_associative}
