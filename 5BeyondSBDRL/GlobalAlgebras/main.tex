...
\input{5BeyondSBDRL/GlobalAlgebras/Tables/2x2_wall_masked_cayley}
}
...
\setlength{\tabcolsep}{2pt}
{\fontsize{8}{10}\selectfont
\input{5BeyondSBDRL/GlobalAlgebras/Tables/2x2_wall_identity_cayley}
}
\setlength{\tabcolsep}{6pt}
\end{landscape}
\end{fullwidth}
...
\setlength{\tabcolsep}{2pt}
{\fontsize{8}{10}\selectfont
\input{5BeyondSBDRL/GlobalAlgebras/Tables/4x1_gridworld_block}
}
\setlength{\tabcolsep}{6pt}
\end{landscape}
\end{fullwidth}
