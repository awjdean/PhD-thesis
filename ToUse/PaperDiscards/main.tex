...
\begin{figure}[H]
    \input{ToUse/PaperDiscards/tikzcd-diagrams/sim-commuting-diagram}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{ToUse/PaperDiscards/Images/fig-restricted-as-identity-example.jpg}
