...
\begin{enumerate}
    ...
    \item Include other info (e.g., equivalence classes, element orders - see (OLD) Algorithm chapter.
...
By checking for group properties, we can confirm that $(\hat{A}^{*}/\sim, \circ_{\sim})$ forms a group.
